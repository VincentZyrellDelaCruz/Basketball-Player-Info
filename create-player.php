<?php
    ...
    if($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submit'])) {
        ...
        if(($age >= 15 && $age <= 99) && ($height >= 100 && $height <= 250) && ($player_no >= 0 && $player_no <= 99)) {
            ...
            if($player_img) {
                $sql = 'INSERT INTO players(name, age, position, team, height, player_no, img_src) VALUES(:name, :age, :position, :team, :height, :player_no, :img_src)';
                ...
                $params = [
                    ...
                    'height' => $height,
                    'player_no' => $player_no,
                    'img_src' => $player_img === 'unknown.jpg' ? null : $player_img
                ];
                $stmt->execute($params);
...
<body style="background-color: #552583;">
    ...
    <main>
        <div class="container my-5">
            <h1 class="text-center text-light">Add Player</h1>
        </div>
        ...
        <div class="container bg-light px-5 py-3 border rounded-5 shadow-lg mb-5">
            ...
            <form method="POST" enctype="multipart/form-data">
                <div class="row gy-3 my-3">
                        ...
                        <div class="row gy-3">
                            ...
                            <div class="col-md-6 col-sm-12">
                                <div class="input-group rounded-5">
                                    ...
                                    <input type="number" name="age" id="age" class="form-control" value="20" required>
                                </div>
                            </div>
                            <div class="col-md-6 col-sm-12">
                                <div class="input-group rounded-5">
                                    <label class="input-group-text bg-warning" for="height">Height (cm)</label>
                                    <input type="number" name="height" id="height" class="form-control" value="160" required>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row gy-3">
                            ...
                            <div class="col-md-6 col-sm-12">
                                <div class="input-group rounded-5">
                                    ...
                                    <input type="number" name="player_no" id="player_no" class="form-control" value="0" required>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-sm-12">
                        <a href="main.php" class="btn btn-secondary rounded-pill px-5 w-100">Back</a>
                    </div>
                    <div class="col-md-6 col-sm-12">
                        <input type="submit" name="submit" value="Add" class="btn btn-success rounded-pill px-5 w-100">
                    </div>
                </div>
            </form>
        </div>
